local t={
  enums={
    ...
    ImGuiCol_={
      ...
      [64]={
        ...
        value="ImGuiCol_TabSelected"},
      [65]={
        calc_value=38,
        name="ImGuiCol_TabUnfocused",
        value="ImGuiCol_TabDimmed"},
      [66]={
        calc_value=39,
        name="ImGuiCol_TabUnfocusedActive",
        value="ImGuiCol_TabDimmedSelected"},
      [67]={
        calc_value=58,
        name="ImGuiCol_NavHighlight",
        value="ImGuiCol_NavCursor"}},
    ...
    ImGuiDockNodeFlags_={
      ...
      [9]={
        ...
        value="ImGuiDockNodeFlags_NoDockingSplit"},
      [10]={
        calc_value=4,
        name="ImGuiDockNodeFlags_NoDockingInCentralNode",
        value="ImGuiDockNodeFlags_NoDockingOverCentralNode"}},
    ImGuiDockNodeState={
      [1]={
        calc_value=0,
    ...
    ImGuiDragDropFlags_={
      ...
      [15]={
        ...
        value="ImGuiDragDropFlags_PayloadAutoExpire"}},
    ...
    ImGuiFreeTypeLoaderFlags_={
      ...
      [11]={
        ...
        value="ImGuiFreeTypeLoaderFlags_NoHinting"},
      [12]={
        calc_value=2,
        name="ImGuiFreeTypeBuilderFlags_NoAutoHint",
        value="ImGuiFreeTypeLoaderFlags_NoAutoHint"},
      [13]={
        calc_value=4,
        name="ImGuiFreeTypeBuilderFlags_ForceAutoHint",
        value="ImGuiFreeTypeLoaderFlags_ForceAutoHint"},
      [14]={
        calc_value=8,
        name="ImGuiFreeTypeBuilderFlags_LightHinting",
        value="ImGuiFreeTypeLoaderFlags_LightHinting"},
      [15]={
        calc_value=16,
        name="ImGuiFreeTypeBuilderFlags_MonoHinting",
        value="ImGuiFreeTypeLoaderFlags_MonoHinting"},
      [16]={
        calc_value=32,
        name="ImGuiFreeTypeBuilderFlags_Bold",
        value="ImGuiFreeTypeLoaderFlags_Bold"},
      [17]={
        calc_value=64,
        name="ImGuiFreeTypeBuilderFlags_Oblique",
        value="ImGuiFreeTypeLoaderFlags_Oblique"},
      [18]={
        calc_value=128,
        name="ImGuiFreeTypeBuilderFlags_Monochrome",
        value="ImGuiFreeTypeLoaderFlags_Monochrome"},
      [19]={
        calc_value=256,
        name="ImGuiFreeTypeBuilderFlags_LoadColor",
        value="ImGuiFreeTypeLoaderFlags_LoadColor"},
      [20]={
        calc_value=512,
        name="ImGuiFreeTypeBuilderFlags_Bitmap",
        value="ImGuiFreeTypeLoaderFlags_Bitmap"}},
    ...
    ImGuiMultiSelectFlags_={
      ...
      [21]={
        ...
        value="ImGuiMultiSelectFlags_SelectOnAuto"}},
    ImGuiNavLayer={
      [1]={
        calc_value=0,
    ...
    ImGuiNavRenderCursorFlags_={
      ...
      [5]={
        ...
        value="ImGuiNavRenderCursorFlags_None"},
      [6]={
        calc_value=2,
        name="ImGuiNavHighlightFlags_Compact",
        value="ImGuiNavRenderCursorFlags_Compact"},
      [7]={
        calc_value=4,
        name="ImGuiNavHighlightFlags_AlwaysDraw",
        value="ImGuiNavRenderCursorFlags_AlwaysDraw"},
      [8]={
        calc_value=8,
        name="ImGuiNavHighlightFlags_NoRounding",
        value="ImGuiNavRenderCursorFlags_NoRounding"}},
    ...
    ImGuiTabBarFlags_={
      ...
      [14]={
        ...
        value="ImGuiTabBarFlags_FittingPolicyShrink"}},
    ...
    ImGuiTreeNodeFlags_={
      ...
      [23]={
        ...
        value="ImGuiTreeNodeFlags_NavLeftJumpsToParent"},
      [24]={
        calc_value=8192,
        name="ImGuiTreeNodeFlags_SpanTextWidth",
        value="ImGuiTreeNodeFlags_SpanLabelWidth"}},
  ...
  structs={
    ...
    ImFontAtlas={
      ...
      [9]={
        name="",
        type="union { ImTextureRef TexRef; ImTextureRef TexID;}"},
      [10]={
        name="TexData",
        type="ImTextureData*"},
      [11]={
