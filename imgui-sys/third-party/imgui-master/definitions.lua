local t={
  ...
  ImGuiInputTextCallbackData_SetSelection={
    [1]={
      args="(ImGuiInputTextCallbackData* self,int s,int e)",
      argsT={
        [1]={
          name="self",
          type="ImGuiInputTextCallbackData*"},
        ...
        [3]={
          name="e",
          type="int"}},
      argsoriginal="(int s,int e)",
      call_args="(s,e)",
      call_args_old="(s,e)",
      cimguiname="ImGuiInputTextCallbackData_SetSelection",
      defaults={},
      funcname="SetSelection",
      location="imgui:2669",
      namespace="ImGuiInputTextCallbackData",
      ov_cimguiname="ImGuiInputTextCallbackData_SetSelection",
      ret="void",
      signature="(int,int)",
      stname="ImGuiInputTextCallbackData"},
    ["(int,int)"]=nil},
  ...
  igBeginPopupContextItem={
    [1]={
      ...
      argsoriginal="(const char* str_id=((void*)0),ImGuiPopupFlags popup_flags=0)",
...
t.ImGuiInputTextCallbackData_SetSelection["(int,int)"]=t.ImGuiInputTextCallbackData_SetSelection[1]
