...
CIMGUI_API ImTextureRef* ImTextureRef_ImTextureRef_Ptr(void* tex_id)
{
    return IM_NEW(ImTextureRef)(tex_id);
}
...
CIMGUI_API void igPushFont_Float(ImFont* font,float font_size_base_unscaled)
{
...
CIMGUI_API void igImage_Nil(ImTextureRef_c tex_ref,const ImVec2_c image_size,const ImVec2_c uv0,const ImVec2_c uv1)
{
...
CIMGUI_API void ImDrawList_PushTextureID(ImDrawList* self,ImTextureRef_c tex_ref)
{
    return self->PushTextureID(ConvertToCPP_ImTextureRef(tex_ref));
}
...
CIMGUI_API void ImFontAtlas_SetTexID_TextureID(ImFontAtlas* self,ImTextureID id)
{
    return self->SetTexID(id);
}
CIMGUI_API void ImFontAtlas_SetTexID_TextureRef(ImFontAtlas* self,ImTextureRef_c id)
{
    return self->SetTexID(ConvertToCPP_ImTextureRef(id));
}
...
CIMGUI_API ImFontAtlasRectId ImFontAtlas_AddCustomRectRegular(ImFontAtlas* self,int w,int h)
{
    return self->AddCustomRectRegular(w,h);
}
CIMGUI_API const ImFontAtlasRect* ImFontAtlas_GetCustomRectByIndex(ImFontAtlas* self,ImFontAtlasRectId id)
{
    return self->GetCustomRectByIndex(id);
}
CIMGUI_API void ImFontAtlas_CalcCustomRectUV(ImFontAtlas* self,const ImFontAtlasRect* r,ImVec2_c* out_uv_min,ImVec2_c* out_uv_max)
{
    return self->CalcCustomRectUV(r,reinterpret_cast<ImVec2*>(out_uv_min),reinterpret_cast<ImVec2*>(out_uv_max));
}
CIMGUI_API ImFontAtlasRectId ImFontAtlas_AddCustomRectFontGlyph(ImFontAtlas* self,ImFont* font,ImWchar codepoint,int w,int h,float advance_x,const ImVec2_c offset)
{
    return self->AddCustomRectFontGlyph(font,codepoint,w,h,advance_x,ConvertToCPP_ImVec2(offset));
}
CIMGUI_API ImFontAtlasRectId ImFontAtlas_AddCustomRectFontGlyphForSize(ImFontAtlas* self,ImFont* font,float font_size,ImWchar codepoint,int w,int h,float advance_x,const ImVec2_c offset)
{
    return self->AddCustomRectFontGlyphForSize(font,font_size,codepoint,w,h,advance_x,ConvertToCPP_ImVec2(offset));
}
...
CIMGUI_API void igPushFont_Nil(ImFont* font)
{
...
CIMGUI_API void igImage_Vec4(ImTextureRef_c tex_ref,const ImVec2_c image_size,const ImVec2_c uv0,const ImVec2_c uv1,const ImVec4_c tint_col,const ImVec4_c border_col)
{
    return ImGui::Image(ConvertToCPP_ImTextureRef(tex_ref),ConvertToCPP_ImVec2(image_size),ConvertToCPP_ImVec2(uv0),ConvertToCPP_ImVec2(uv1),ConvertToCPP_ImVec4(tint_col),ConvertToCPP_ImVec4(border_col));
}
...
CIMGUI_API ImVec2_c igGetContentRegionMax()
{
    return ConvertFromCPP_ImVec2(ImGui::GetContentRegionMax());
}
CIMGUI_API ImVec2_c igGetWindowContentRegionMin()
{
    return ConvertFromCPP_ImVec2(ImGui::GetWindowContentRegionMin());
}
CIMGUI_API ImVec2_c igGetWindowContentRegionMax()
{
...
CIMGUI_API void igRenderNavHighlight(const ImRect_c bb,ImGuiID id,ImGuiNavRenderCursorFlags flags)
{
    return ImGui::RenderNavHighlight(ConvertToCPP_ImRect(bb),id,flags);
}
