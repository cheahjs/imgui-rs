...
struct ImFontAtlas
{
    ...
    int TexMaxHeight;
    void* UserData;
    union { ImTextureRef_c TexRef; ImTextureRef_c TexID; };
...
CIMGUI_API ImVec2_c igGetContentRegionMax(void);
CIMGUI_API ImVec2_c igGetWindowContentRegionMin(void);
CIMGUI_API ImVec2_c igGetWindowContentRegionMax(void);
