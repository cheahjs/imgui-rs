...
pub const ImGuiConfigFlags_DpiEnableScaleFonts: ImGuiConfigFlags_ = 16384;
pub const ImGuiConfigFlags_DpiEnableScaleViewports: ImGuiConfigFlags_ = 32768;
...
pub const ImGuiCol_NavHighlight: ImGuiCol_ = 58;
